...
@section('content')
   ...
   {{ Form::open(array('url' => $data['route'], 'class' => 'form-horizontal', 'files' => true)) }}
       ...
       <!-- Form Name -->
       <legend>
           <span class="glyphicon glyphicon-plus-sign"></span> Adicionar novo {{$data['title']}}
       ...
       <div class="form-group {{ $errors->first('titulo', 'has-error') }}">
         ...
         <div class="col-md-4">
            {{ Form::text('titulo', Input::old('titulo'), array('placeholder' => 'Título do conteúdo', 'class' => 'form-control input-md', 'required', 'id' => 'titulo')) }}
       ...
       <div class="form-group {{ $errors->first('introducao', 'has-error') }}">
         ...
         <div class="col-md-4">
             {{ Form::textarea('introducao', Input::old('introducao'), array('placeholder' => 'Introdução do conteúdo', 'class' => 'form-control', 'required', 'size' => '30x4', 'maxlength' => '300')) }}
