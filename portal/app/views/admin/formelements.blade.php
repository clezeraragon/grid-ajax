...
<form method="POST">
                        ...
                        <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" data-inputmask='"mask": "99.999.999/9999-99"' data-mask/>
                                                    </div>
                                                    <!-- /.input group --> </div>
                                                <!-- /.form group -->
                                                <!-- phone mask -->
...
<div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" data-inputmask='"mask": "(99)99999999[9]"' data-mask/>
                                                    </div>
                                                    <!-- /.input group --> </div>
                                                <!-- /.form group -->
                                                <!-- phone mask -->
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <h4>&nbsp;</h4>
                    <div class="form-group">
                        <label for="source" class="control-label">Select your state</label>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    ...
                    <!--max length starts-->
                    <div class="form-group">
                        <label for="default" class="control-label">Default MaxLength</label>
                        <input maxlength="25" name="defaultconfig" id="defaultconfig" type="text" class="form-control" placeholder="Placeholder text"></div>
                    <div class="form-group">
                        <label for="default" class="control-label">Threshold value</label>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label>Auto Grow Basic</label>
                        <div class="input-group">
                            <textarea placeholder="Write something here..." class="form-control" data-autogrow rows="3" cols="80"></textarea>
                        </div>
                        <!-- /.input group --> </div>
                    <div class="form-group">
                        <label>Heavy padding</label>
                        <div class="input-group">
                            <textarea style="padding: 45px;" placeholder="Write something here..." class="auto2 form-control" data-autogrow rows="3" cols="80"></textarea>
                        </div>
                        <!-- /.input group --> </div>
                    <div class="form-group">
                        <label>No Scrollbar</label>
                        <div class="input-group">
                            <textarea placeholder="Write something here..." style="padding: 20px; border: 5px solid black; box-sizing: border-box;" class="span3 form-control scroll" data-autogrow rows="3" cols="80"></textarea>
                        </div>
                        <!-- /.input group --> </div>
                    <div class="form-group">
                        <label>Initially hidden</label>
                        <div class="input-group">
                            <div class="span4">
                                <textarea style="display: none;" placeholder="Write something here..." class="span3 form-control" data-autogrow rows="3" cols="80"></textarea>
